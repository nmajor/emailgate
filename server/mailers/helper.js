...
export function getActivitySummaryExampleData() {
  		...
  		<td class="header container">
  				...
  				<div class="content">
  					...
  					<tr>
  						...
  						<td align="right"><h6 class="collapse"><a href="https://www.missionarymemoir.com">Visit Site</a></h6></td>
  					</tr>
  				</table>
  				</div>
  	...
  	<tr>
  		...
  		<td class="container">
  				...
  				<tr>
  					<td align="center">
  						<p>
  							Please <a href="https://missionarymemoir.freshdesk.com/support/tickets/new">Contact Us</a> with any questions!
  						</p>
  					</td>
  				</tr>
  			</table>
...
//                   <p className="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.</p>
//                   {/* A Real Hero (and a real human being) */}
//                   <p><img src="http://placehold.it/600x300" role="presentation" /></p>
//                   {/* Callout Panel */}
//                   <p className="callout">
...
//                   <br />
//                   {/* social & contact */}
//                   <table className="social" width="100%">
//                     <tbody>
//                       <tr>
//                         <td>
//                           <table align="left" className="column">
//                             <tbody>
//                               <tr>
//                                 <td>
//                                   <h5 className>Connect with Us:</h5>
//                                   <p className><a href="#" className="soc-btn fb">Facebook</a> <a href="#" className="soc-btn tw">Twitter</a> <a href="#" className="soc-btn gp">Google+</a></p>
//                                 </td>
//                               </tr>
//                             </tbody>
//                           </table>{/* /column 1 */}
