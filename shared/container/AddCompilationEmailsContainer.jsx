...
class AddCompilationEmailsContainer extends Component {
  ...
  renderFilterContainer() {
    if (this.currentAccount) {
      ...
      } else if (this.currentAccount.kind === 'google' && !_.get(this.currentAccount, 'props.token.refresh_token') && (new Date).getTime() > _.get(this.currentAccount, 'props.token.expiry_date')) {
